...
const Motivation = () => {
  const articles = [
    ...
    },
    {
      ...
      content:
        "Kafka on the Shore (海辺のカフカ, Umibe no Kafuka) is a 2002 novel by Japanese author Haruki Murakami. Its 2005 English translation was among The 10 Best Books of 2005 from The New York Times and received the World Fantasy Award for 2006. The book tells the stories of the young Kafka Tamura, a bookish 15-year-old boy who runs away from his Oedipal curse, and Satoru Nakata, an old, disabled man with the uncanny ability to talk to cats. The book incorporates themes of music as a communicative conduit, metaphysics, dreams, fate, and the subconscioussAfter the release of the book, Murakami allowed for questions about the novel to be sent in, and responded to many of them. The novel was generally well-received, with positive reviews from John Updike and The New York Times.",
    },
    {
      id: 4,
      image: card_img4,
    ...
    },
    {
      ...
      name: "1Q84",
      content:
        "1Q84 (いちきゅうはちよん, Ichi-Kyū-Hachi-Yon, stylized in the Japanese cover as ichi-kew-hachi-yon is a novel written by Japanese writer Haruki Murakami, first published in three volumes in Japan in 2009–10.[1] It covers a fictionalized year of 1984 in parallel with a real one. The novel is a story of how a woman named Aomame begins to notice strange changes occurring in the world. She is quickly caught up in a plot involving Sakigake, a religious cult, and her childhood love, Tengo, and embarks on a journey to discover what is real .The novel's first printing sold out on the day it was released and sales reached a million within a month.[2] ",
    },
    {
      id: 6,
      image: card_img6,
    ...
    <>
      ...
      <div className="app">
        <header className="header">
          ...
          <p>
            Here we provide you with ideas drawn from the pages of books to
            improve your self-worth and life experience.
          </p>
        </header>
        <main className="main">
